...
//    protected $server = 'http://www.skudler.com/api/';
    ...
    public function addSubscription($eventId, $subscriberInfo, $onlyResponse = true)
    {
        ...
        $subscriberInfo['eventId']          = $eventId;
        $subscriberInfo['reference_date']   = isset($subscriberInfo['reference_date']) ? $subscriberInfo['reference_date'] : date('Y-m-d H:i:s');

        return $this->getResource('POST', $resource, $onlyResponse, $subscriberInfo);
    }
